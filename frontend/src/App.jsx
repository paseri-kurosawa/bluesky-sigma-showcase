          ...
          <>
            ...
            <div className="info-modal" style={{ top: `${headerHeight}px` }}>
              ...
              <div className="info-modal-content">
                ...
                <p><strong>ランキングについて</strong></p>
                <p>• ユーザーランキングは、ネットワーク内の影響力の強さを示しています。</p>
                <p>• 影響力は、フォロー関係をベースにした独自計算式でスコアリングされます。</p>
                <p>• ハッシュタグランキングは、そのネットワーク内のユーザーが使っている頻度を示しています。</p>
                <p>• 現在アクティブに使用されているハッシュタグは強調表示されます。</p>
                <p>• ハッシュタグを選択すると、ネットワークグラフのユーザーとエッジが絞り込まれます。</p>
                <p>• 統計情報は、各ネットワークごとに計算されています。</p>
